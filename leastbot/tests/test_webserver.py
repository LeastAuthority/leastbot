...
class WebserverTests (MockingTestCase):
    def setUp(self):
        ...
        self.s = webserver.WebServer(self.m_reactor, self.f_secret, self.m_handle_event)
    ...
    def test_listen(self):
        ...
        self.assert_calls_equal(self.m_reactor, [call.listenTCP(1234, self.m_Site.return_value)])
